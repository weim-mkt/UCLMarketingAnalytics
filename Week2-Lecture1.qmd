...
-   **Interpretation**: 7.2 means that, the first month incremental sales units would be 7.2 million pounds.
...
```{r}
#| eval: false
# click through rate is the % of clicking customer who see the ads
click_through_rate <- 0.2

# conversion rate is the % of purchasing customer who clicked
conversion_rate <- 0.2
```
