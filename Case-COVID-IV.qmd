...
-   Please report the summary statistics of the trip data. @tbl-summary reports the results.
...
-   We can plot the trend of COVID-19 cases using ggplot2 package. @fig-newcases plots the trend of new COVID cases in each city by date.
...
-   Please run three univariate simple linear regressions, with the outcome being the 3 aforementioned dependent variables and explanatory variable being new cases only. The results are reported in @tbl-ols. Interpret the results.
