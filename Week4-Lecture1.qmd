...
- Euclidean distance 
    - $d_{\text{euc}}(2, 1) = \sqrt{(5-3)^2 + (10-4)^2} = \sqrt{2^2 + 6^2} = \sqrt{40}$
    - $d_{\text{euc}}(2, 3) = \sqrt{(5-20)^2 + (10-12)^2} = \sqrt{15^2 + 2^2} = \sqrt{229}$
...
ggplot(data, aes(x = Income, y = Spending)) +
    ...
    geom_text(aes(x = 7.5, y = 3.5, label = "d_euc(1, 2) = sqrt(2^2 + 6^2) = sqrt(40)"), vjust = 1) +
    ...
    geom_text(aes(x = 15, y = 8, label = "d_euc(2, 3) = sqrt(15^2 + 2^2) = sqrt(229)"), vjust = 1)
...
- Distance
    - $d_{\text{man}}(2, 1) = |5-3| + |10-4| = 2 + 6 = 8$
    - $d_{\text{euc}}(2, 3) = |5-20| + |10-12| = 15 + 2 = 17$
