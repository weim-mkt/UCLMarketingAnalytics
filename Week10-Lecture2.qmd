...
-   You've made me very proud:
    -   It gives me see that you all have made huge progress in your R skills and marketing analytics models!
...
|                                                                                                |                                                                                                                     |
| Then you can \[**D7**\] start to make it \[**G**\] better                                      | Then you can \[**D7**\] start to make Wei \[**G**\] happier                                                         |
+------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
...
|                                                                                                |                                                                                                                     |
| The \[**C**\] minute you let her under your \[**G**\] skin                                     | The \[**C**\] minute you open Jupyter notebook \[**G**\] in my class                                                |
|                                                                                                |                                                                                                                     |
| Then you be\[**D7**\]gin to make it \[**G**\] better \[**G**\]                                 | I know it's time \[**D7**\] to fight the oppression \[**G**\] from Python!                                          |
+------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
| **\[G7\]**And any time you feel the **\[C\]** pain hey **\[Em\]** Jude re-\[**Am**\]frain      | **\[G7\]**And any time you have any question **\[C\]** hey **\[Em\]** Tom come to \[**Am**\] Wei                    |
|                                                                                                |                                                                                                                     |
| Don't **\[Am7\]** carry the **\[D\]** world u**\[D7\]**pon your **\[G\]** shoulder **\[G\]**   | Don't **\[Am7\]** carry the **\[D\]** world u**\[D7\]**pon your **\[G\]** shoulder **\[G\]**                        |
|                                                                                                |                                                                                                                     |
| **\[G7\]**For well you know that it's a **\[C\]** fool who **\[Em\]** plays it **\[Am\]** cool | **\[G7\]**For well you know that it's a **\[C\]** fool who **\[Em\]** plays it **\[Am\]** cool                      |
|                                                                                                |                                                                                                                     |
| By **\[Am7\]** making his **\[D\]** world a **\[D7\]** little **\[G\]** colder                 | By **\[Am7\]** making his **\[D\]** world a **\[D7\]** little **\[G\]** colder                                      |
|                                                                                                |                                                                                                                     |
| **\[G\]** Na na na **\[G7\]**na na na na **\[D7\]** na na **\[G\]** **\[D7\]**                 | **\[G\]** Now repeat after me **\[G7\]** R is the best language **\[D7\]** Better than Python! **\[G\]** **\[D7\]** |
+------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
:::
