...
1.  We aim to do customer segmentation based on *total spending* and *income.* First of all, we need to re-scale the two variables using `scale()`, because the two variables are of very different scales
