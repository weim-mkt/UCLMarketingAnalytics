---
title: "The Causal Impact of COVID-19 on Uber Driver Labor Supply^[This case was prepared by Wei Miao, UCL School of Management, University College London for MSIN0094 Marketing Analytics module. This case was developed to provide material for class discussion rather than to illustrate either effective or ineffective handling of a business situation. Names and data may have been disguised or fabricated. Please do not circulate without permission. Copyrights reserved.]"
author: Dr Wei Miao
...
data_driver <- read.csv('https://www.dropbox.com/s/znoqsgmymfyjs07/data_driver.csv?dl=1')
...
## Univariate OLS regression Analyses
...
> Complete the remaining outcome variables after class.
