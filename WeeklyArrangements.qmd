...
-   Install R, RStudio, and Quarto following the [guide](https://weim-mkt.github.io/UCLMarketingAnalytics/R-installR.html).
...
-   Make sure you have installed R and RStudio following the [installation guide](https://weim-mkt.github.io/UCLMarketingAnalytics/R-installR.html). If you have missed the R tutorial in the induction week, please watch the recording to catch up before class.

-   Complete the R exercise on the `Case-ProfitabilityAnalysis-Stu.qmd`. You can find the file on Moodle.
:::
