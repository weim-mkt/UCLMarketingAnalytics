...
-   R will fill in the matrix by order and recycle from the beginning of the vector to fill in the remaining elements, with a warning message.
...
-   Data Frame is the R object that we will deal with most of the time. You can think of `data.frame` as a spreadsheet in excel.
