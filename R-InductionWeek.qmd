...
-   R is both a programming language for statistical computing, which is free and open-source (<https://www.r-project.org/about.html>).
...
## Where to write your R codes: Console

## Where to write your R codes: `.R` Script

## Where to write your R codes: `Quarto`
