...
::: {.content-visible when-format="html" }
> The best level would be user level. 
> User-device level would be too granular and can easily cause crossover effects.
:::
...
::: {.content-visible when-format="html" }
> After two weeks, B was looking pretty good. Its daily eRPM was on average $0.131 higher than A’s. Would this translate into annual revenues worthy of the necessary data science investment? Exhibits 2 and 3 provide the daily results of the A/B test.10
:::
