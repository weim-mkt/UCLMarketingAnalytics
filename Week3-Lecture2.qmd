...
-   **Customer value segmentation** is for targeting decisions based on customers' potential longterm financial and strategic value to your company.
...
Conventional segmentation methods require heavy human judgments. A more sensible more is to "let the data speak".
...
K-means clustering is the most commonly used unsupervised machine learning algorithm for partitioning a given data set into a set of *k* groups (i.e. *k* clusters), where *k* represents the number of groups pre-specified by the analyst. It classifies customers into multiple segments (i.e., clusters), such that customers within the same cluster are as similar as possible, whereas customers from different clusters are as dissimilar as possible. 
...
-   `trace`: provide intermediate step information?
...
5.  Compare the CLV in the two segments, and decide which segment to serve.
    -   This is general idea of segmentation and targeting using unsupervised learning
