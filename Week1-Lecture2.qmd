...
[^1]: Material and production labor costs for producing a unit of product; often represented in **percentage terms,** e.g., COGS of 60% means the costs are 60% of retail prices.
...
::: columns
::: {.column width="50%"}
![](images/PinePhone.png){fig-align="center" width="100"}
:::
